...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.myHolder> {
    ...
    public MyAdapter(MainActivity mainActivity, int[] images, String[] Name, String[] versionNumber, String[] apiLevel, String[] releaseDate)
    {
        ct = mainActivity;
        myImages = images;
        myName = Name;
    ...
    public void onBindViewHolder(@NonNull MyAdapter.myHolder holder, int position) {
        ...
        holder.tv1.setText("Code Name: "+ myName[position]);
