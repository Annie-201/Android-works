...
public class ForgetPasswordActivity<ForgotPasswordActivity> extends AppCompatActivity {
    EditText email;
        ...
        auth.sendPasswordResetEmail(email).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    ...
                    Toast.makeText(ForgetPasswordActivity.this, "Please chek email link is sent", Toast.LENGTH_SHORT).show();
